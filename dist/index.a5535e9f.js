...
(function() {
    ...
    testbutton.addEventListener('click', async (_)=>{
        console.log('Inside!');
        try {
            (0, _axiosDefault.default).post('https://api.hubapi.com/crm/v3/objects/contacts', {
                headers: {
...
},{"regenerator-runtime/runtime":"dXNgZ","axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dXNgZ":[function(require,module,exports,__globalThis) {
/**
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["6xvnb","1E7ZB"], "1E7ZB", "parcelRequire94c2")
